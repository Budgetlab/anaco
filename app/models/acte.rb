class Acte < ApplicationRecord
  ...
  def self.ransackable_attributes(auth_object = nil)
    ["action", "activite", "annee", "autorisation_tutelle", "avis_programmation", "beneficiaire", "budget_executoire", "categorie", "categorie_organisme", "categorie_t2", "centre_financier_code", "commentaire_proposition_decision", "concordance_recettes_tiers", "conformite", "consommation_credits", "created_at", "date_saisine", "date_cloture", "date_deliberation_ca", "date_limite", "decision_finale", "delai_traitement", "deliberation_ca", "destination", "disponibilite_credits", "etat", "flux", "gestion_anticipee", "groupe_marchandises", "id", "id_value", "imputation_depense", "instructeur", "liste_actes", "montant_ae", "montant_global", "nature", "nature_categorie_organisme", "nombre_actes", "nom_organisme", "nomenclature", "numero_chorus", "numero_deliberation_ca", "numero_formate", "numero_marche", "numero_tf", "numero_utilisateur", "objet", "observations", "observations_deliberation_ca", "operation_budgetaire", "operation_compte_tiers", "ordonnateur", "pdf_generation_status", "perimetre", "pre_instruction", "precisions_acte", "programmation", "programmation_prevue", "proposition_decision", "renvoie_instruction", "services_votes", "sheet_data", "soutenabilite", "titre", "type_acte", "type_engagement", "type_montant", "type_observations", "updated_at", "user_id", "valideur"]
  end
  def self.ransackable_associations(auth_object = nil)
    ["centre_financier_principal", "centre_financiers", "echeanciers", "organismes", "poste_lignes", "rich_text_commentaire_disponibilite_credits", "suspensions", "t2_detail", "user"]
  end
  ...
  def tous_actes_meme_chorus
    ...
    query = Acte.where(numero_chorus: numero_chorus, user_id: user_id, perimetre: perimetre)
  ...
  def self.duree_moyenne_suspensions
    ...
    suspensions_ids = Suspension.where(acte_id: pluck(:id)).pluck(:id)
  ...
  def self.import_from_backup(file)
    ...
    begin
      ...
      Acte.where(id: id_map.values).each do |acte|
